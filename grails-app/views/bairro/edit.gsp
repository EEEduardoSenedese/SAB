    ...
    <body>
        ...
        <section class="main col-sm-offset-2">
            <div id="edit-bairro" class="content scaffold-edit" role="main">
                ...
                <g:hasErrors bean="${this.bairro}">
                <ul class="errors" role="alert">
                    <g:eachError bean="${this.bairro}" var="error">
                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                    </g:eachError>
                </ul>
                </g:hasErrors>
                <g:form resource="${this.bairro}" method="PUT">
                    <g:hiddenField name="version" value="${this.bairro?.version}" />
                    <fieldset class="form">
                        <f:all bean="bairro"/>
                    </fieldset>
