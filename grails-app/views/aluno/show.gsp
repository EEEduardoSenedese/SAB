...
<html>
    ...
    <body>
        ...
        <div id="show-aluno" class="content scaffold-show" role="main">
            ...
            <f:display bean="aluno" />
            <g:form resource="${this.aluno}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.aluno}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
