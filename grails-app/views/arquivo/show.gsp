...
<html>
    ...
    <body>
        ...
        <div id="show-arquivo" class="content scaffold-show" role="main">
            ...
            <f:display bean="arquivo" />
            <g:form resource="${this.arquivo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.arquivo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    <input class="delete" type="submit" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                    <g:link class="create" action="create" controller="Aluno" params="['arquivo.id': this.arquivo.id]">Adicionar Aluno</g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
