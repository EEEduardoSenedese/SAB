    ...
    <body>
		...
		<section class="main col-sm-offset-2">
            <div id="show-editora" class="content scaffold-show" role="main">
                ...
                <f:display bean="editora" />
                <g:form resource="${this.editora}" method="DELETE">
                    <fieldset class="buttons">
                        <g:link class="edit" action="edit" resource="${this.editora}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
