...
<html>
    ...
    <body>
        ...
        <div id="show-serie" class="content scaffold-show" role="main">
            ...
            <f:display bean="serie" />
            <g:form resource="${this.serie}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.serie}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
